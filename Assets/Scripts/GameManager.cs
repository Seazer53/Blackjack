...
public class GameManager : MonoBehaviour
{
    ...
    private void DealClicked()
    {
        ...
        scoreText.text = "El: " + playerScript.handValue.ToString();
        dealerScoreText.text = "El: " + dealerScript.handValue.ToString();
        ...
        standBtnText.text = "Kal";

        // Set standard pot size
        pot = 40;
        betsText.text = "Bahis: ₺" + pot.ToString();
    ...
    {
        while (dealerScript.handValue < 18 && dealerScript.cardIndex < 10)
        {
    ...
    void RoundOver()
    {
        ...
        {
            mainText.text = "Herkes iflas: Bahisler iade";
        ...
        {
            mainText.text = "Berabere: Bahisler iade";
            playerScript.AdjustMoney(pot / 2);
        }
